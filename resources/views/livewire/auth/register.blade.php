    ...
    <form wire:submit.prevent="register" action="#" method="POST">
        ...
        <div class="mt-6">
            <span class="block w-full rounded-md shadow-sm">
                <button type="submit" class="w-full text-cyan-400 px-3 py-2 rounded-md text-sm font-medium transition duration-500 ease-in-out bg-opacity-0 border-2 border-white-400 hover:text-cyan-600 transform hover:-translate-y-1 hover:scale-110 mr-2 flex-shrink-0 w-full group block">
                    Register
                </button>
            </span>
        </div>
        ...
        <div class="mt-6">
            <p class="mt-2 text-center text-sm leading-5 text-cyan-400 max-w">
                <a href="/login" class="font-medium text-cyan-400 hover:text-cyan-600 focus:outline-none focus:underline transition ease-in-out duration-150">
